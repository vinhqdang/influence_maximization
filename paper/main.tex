...
correction. This residual gap is attributable to repeated-greedy's
expensive per-round joint-rollout evaluation out-ramping MF-BWI-Fair's
cheaper, mean-field-decoupled Lagrangian index specifically on graphs
with richer, more disparate community structure, rather than to the
mean-field approximation degrading with density or degree per se (the
smaller, denser \texttt{real\_facebook\_348} and \texttt{real\_facebook\_686}
